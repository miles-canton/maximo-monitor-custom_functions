...
class HelloWorld_MJ(BaseTransformer):
    '''
    The docstring of the function will show as the function description in the UI. HelloWorld_MJ.
    '''
    ...
    def execute(self, df):
        ...
        df[self.greeting_col] = 'Hello %s from the function HelloWorld_MJ!' % self.name
